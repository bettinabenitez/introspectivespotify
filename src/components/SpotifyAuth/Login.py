...
async def spotify_login(bot, user):
    ...
    title_message = "Spotify Login for " + user.name
    reply = f"Click [here]({login_url}) to login with your Spotify account. \n" \
            "Please reply to me with the URL you are redirected to. \n" \
            "The reply URL should start with 'localhost'."
